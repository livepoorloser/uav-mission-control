...
void DSconfig::getParamters(const ros::NodeHandle &nh){
    ...
    read_essential_param(nh, "PathPoints/A_points", path_point.A_points);
    read_essential_param(nh, "PathPoints/B_points", path_point.B_points);
    read_essential_param(nh, "PathPoints/C_points", path_point.C_points);
    read_essential_param(nh, "PathPoints/D_points", path_point.D_points);
    read_essential_param(nh, "PathPoints/perform_time", path_point.perform_time);
    read_essential_param(nh, "PathPoints/planner_time", path_point.planner_time);
